...
const Testimonials = ({ testimonials }) => {
  ...
  useEffect(() => {
    ...
    if (carouselElement && testimonials.length > 0) {
      bsCarousel = new Carousel(carouselElement, {
        interval: 6000,
        ride: 'carousel'
      });
    }
  ...
  return (
    <section className="bg-light py-5 border-top" id="testimonials">
      <div className="container my-5">
        ...
        {/* Le inyectamos la llave aquí para que React lo formatee y Bootstrap no se maree */}
        <div key={carouselKey} id="testimonialsCarousel" className="carousel slide shadow-lg rounded-4 bg-white overflow-hidden">
